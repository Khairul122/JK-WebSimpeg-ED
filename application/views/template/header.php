...
<head>
  ...
  <!-- Date Picker -->
  <link rel="stylesheet"
    href="<?= base_url('template/admin') ?>/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet"
    href="<?= base_url('template/admin') ?>/bower_components/bootstrap-daterangepicker/daterangepicker.css">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?= base_url('admin/keluar') ?>"
                      onclick="return(confirm('Anda Akan Keluar Dari Halaman Administrator'))"
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <?php if ($this->session->userdata('level') == "admin") { ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/pegawai') ?>" class="active"><i class="fa fa-circle-o"></i>Pegawai</a>
                </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('laporan/laporan_pegawai'); ?>"><i class="fa fa-circle-o"></i> Data Pegawai</a>
                </li>
                <li><a href="<?= base_url('laporan/laporan_absensi'); ?>"><i class="fa fa-circle-o"></i> Data Absensi</a>
                </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/user_admin') ?>" class="active"><i class="fa fa-circle-o"></i>User </a>
                </li>
              </ul>
            </li>
          <?php } elseif ($this->session->userdata('level') == "user") { ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="<?= base_url('laporan/laporan_absensi'); ?>"><i class="fa fa-circle-o"></i> Data
                    Absesensi</a></li>
                <li><a href="<?= base_url('laporan/laporan_tpp'); ?>"><i class="fa fa-circle-o"></i> Data TPP</a></li>
          ...
          <?php } elseif ($this->session->userdata('level') == "pegawai") { ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?= base_url('admin/profil_pegawai'); ?>"><i class="fa fa-circle-o"></i>Lihat Data Profil
                    Lengkap</a></li>
              </ul>
            </li>
